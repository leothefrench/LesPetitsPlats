...
function secondarySearch(nameTag, nameClass, nameFunction, searchBloc, nameChevronUp, inputSearchBtn, nameListElements) {
    ...
    listElementsDiv.classList.add(`${nameListElements}`)
